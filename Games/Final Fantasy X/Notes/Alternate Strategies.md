...
### General Information
  There are alot of stuff that we can go on about blitzball and there are a lot of strategies involving it. But, here are some general stuff before move on:
    ...
    * If they want to troll, They are going to troll. They are called Luca Trollers for a reason.
...
### Graav and Balgerda
  ...
  And now Balgerda, she is a minor threat but don't take her lightly. You want to lure her out of her position to prevent her from breaking with your shooter (Tidus or Wakka) but some
...
#### Why should I do it?
  ...
  * If you time your scores correctly, the Goers won't have time to score. I usually leave around 15-20secs of gametime to make sure I can have ample space to get the ball to Tidus and score before the timer.
  * If you manage to crit score with Tidus on the 1st Half you can opt out of scoring or do a 2-0 to make sure the Goers don't troll you. A slow win tends to fair better than a fast loss coz Tidus can be a really big deal during the Mid Game Boss Rush.
  * Wakka 

#### Should I get Jecht Shot?
  It depends on you actually. The reason why runners opt out of Jecht Shot is because the cutscenes get longer on the ship going to Luca. You also need to note that Jecht Shot has a maximum 20seconds animation (excluding ball travel time), so time it right before you attempt to score(2:35 is the bare minimum anything more and you'll cry sayonara to your timeloss). The advantages are that you don't need to break with Balgerda (or if the gods really don't want you to win, Graav) coz Jecht Shot with will deal with them. So if you feel like going toe to toe with the Goers with Jecht Shot then feel completely Free.
